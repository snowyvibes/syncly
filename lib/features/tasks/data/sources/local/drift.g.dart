...
class $$TasksTableFilterComposer
    extends Composer<_$TasksDatabase, $TasksTable> {
...
class $$TasksTableTableManager
    extends
        RootTableManager<
          ...
          (Task, BaseReferences<_$TasksDatabase, $TasksTable, Task>),
          Task,
          PrefetchHooks Function()
        > {
  $$TasksTableTableManager(_$TasksDatabase db, $TasksTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
